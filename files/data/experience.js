var companyLogoFolderPath = 'images/companies/'
  ...
  },
  {
    ...
    jobs: [
      ...
      },
      {
        ...
        description:
          'During this period I have had two tasks: a mobile application built specifically for people that would install their EnergyConnectors in the future (Commissioning App) and rebuilding their already existing user interface. \n\n \
    ...
    jobs: [
      {
        ...
        description:
          'External Community Manager for the Public Beta server of InnoGamesâ€™ western-themed browser game called â€œThe-Westâ€. I have been personally playing the game for over eight years at the moment I got hired in the company. I have been a volunteer moderator for the past three years. \n\n\
    ...
    jobs: [
      {
        ...
        description:
          'During the third semester I have been hired a student lecturer for the SDJ1 (Software Development with Java) class. \n\
